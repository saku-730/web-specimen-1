...
\restrict cJNCq7qFobBavQLkVoQDxOPoTq3sRtvYbQRTQ5tJauoRXFPAkEEhCsKizyeAE92
...
CREATE TABLE public.users_defaults (
    user_id integer NOT NULL,
    theme text DEFAULT 'white'::text NOT NULL
);
...
--
-- Name: users_defaults users_defaults_userid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.users_defaults
    ADD CONSTRAINT users_defaults_userid_fkey FOREIGN KEY (user_id) REFERENCES public.users(user_id);
...
\unrestrict cJNCq7qFobBavQLkVoQDxOPoTq3sRtvYbQRTQ5tJauoRXFPAkEEhCsKizyeAE92
